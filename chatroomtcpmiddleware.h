#ifndef CHATROOMTCPMIDDLEWARE_H
#define CHATROOMTCPMIDDLEWARE_H
...
/*!
    \class ChatRoomTcpMiddleware
    \brief The ChatRoomTcpMiddleware is the middle layer
        between Application and Transport Level.
*/
class ChatRoomTcpMiddleware : public QObject
{
    Q_OBJECT
public:
    explicit ChatRoomTcpMiddleware(QObject *parent = nullptr);
    void listen(const uint port,
